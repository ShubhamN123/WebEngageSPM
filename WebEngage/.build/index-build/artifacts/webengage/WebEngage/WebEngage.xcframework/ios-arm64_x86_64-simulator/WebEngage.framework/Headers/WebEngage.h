...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions webengageConfig:(WebEngageConfig *)webengageConfig;
...
/**
 *  Sets an expiry timer for push notifications. Notifications scheduled after this time will be considered expired.
 *
 *  @param expiryTimeInterval The expiry time as NSTimeInterval (seconds since 1970).
 */
- (void)setExpiryTimerForPushNotification:(NSInteger)expiryMinutes;
